# BMS-4073: Notification Services — Abandoned Cart Reminder & Order Confirmation |ECOM|

## Related
- Jira: https://ohanafy.atlassian.net/browse/BMS-4073
- Testing: [[BMS-4073]] (in Testing/)
- Docs: [[BMS-4073]] (in Documentation/)
...
As an Retail User, I want the abandoned cart reminder and order confirmation notifications to send emails and SMS to eligible portal customers based on their preferences and delivery cutoff windows, so that customers are reminded to place orders and receive confirmation when they do.
