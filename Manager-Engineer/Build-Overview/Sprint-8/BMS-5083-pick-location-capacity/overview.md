...
sprint: "none"
sprint_status: dormant   # ⚠ BMS-4467 IS in Sprint 9 and In Progress in Jira, but assigned to "chris" (not this pipeline) — appears to be a separate reporting-analytics track reusing the same ticket number, not a resumption of THIS folder's already-Done build. Verify before assuming this folder has live work.
sprint_history: ["Sprint 7", "Sprint 8"]
po: Elliot Flores
updated: 2026-07-13
tags:
  - manager-engineer
