...
sprint: "none"
sprint_status: dormant   # BMS-4217 is Done, last carried Sprint 8, NOT in Sprint 9 (checked 2026-07-13). ⚠ NOTE: there's a live agent worktree on this branch with 4 uncommitted files (per Branch-Org Manager) — verify it's not stray/orphaned work before treating this as fully dormant.
