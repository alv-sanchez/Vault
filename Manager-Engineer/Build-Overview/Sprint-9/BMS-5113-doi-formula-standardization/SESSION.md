...
- **Dev org:** `bms-5113-doi` (has BMS-3742's code + the consolidated-branch follow-ons deployed, plus live demo data)
...
- **BMS-3742** — draft PR #513, 21/21 tests passing, before/after proof (old proxy DOI 24 → new source DOI 48 on identical fixture). Live demo data seeded in `bms-5113-doi`: Riverbend IPA @ Montgomery AL Distribution Center → DOI 48/64/72 (30/60/90d), via the actual nightly batch.
